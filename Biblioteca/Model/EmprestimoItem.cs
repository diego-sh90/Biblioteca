...
namespace Biblioteca.Model
{
    ...
    class EmprestimoItem
    {
        ...
        {
            get { return this.codExemplar; }
            set { this.codExemplar = value; }
        }
        [Column("dataretirada")]
        ...
        {
            get { return this.dataDevolucaoPrevista; }
            set { this.dataDevolucaoPrevista = value; }
        }
        [Column("datadevolucaorealizada")]
        public int DataDevolucaoRealizada
        {
            get { return this.dataDevolucaoRealizada; }
            set { this.dataDevolucaoRealizada = value; }
        }
        [Column("status")]
        public int Status
        {
        ...
        {
            get { return this.exemplar; }
            set { this.exemplar = value; }
        }
